...
ThreadPool::ThreadPool(int thread_size) : thread_size(thread_size), is_stated(false), m_mutex(), m_mutex2(), m_queue_mutex(), m_cond(), m_queue_cond(){
...
void ThreadPool::__add_one_task(Task * t) {
    std::unique_lock<std::mutex> lock1(m_queue_mutex);
